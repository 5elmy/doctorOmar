  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      if (
        ...
        data.append(
          "image_active_private_content",
          values.image_active_private_content === true ? 1 : 0
        );
        data.append(
          "image_active_elder",
          values.image_active_elder === true ? 1 : 0
        );
  ...
  useEffect(() => {
    if (settings) {
      formik.setValues({
        ...
        image_active_private_content:
          settings?.image_active_private_content === 1 ? true : false,
        ...
        <form className="w-100" onSubmit={formik.handleSubmit}>
          ...
          <Row>
            <Col sm={12}>
              <div className="form-group d-flex justify-content-end mb-4">
                <label
                  htmlFor="image_active_private_content"
