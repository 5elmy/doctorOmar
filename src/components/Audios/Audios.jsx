        ...
        if (!values.id) {
          dispatch(
            addAudioApi({
              ...
              audios_time: timeToSeconds(toggle.duration.trim()), // Convert to seconds
          ...
          const formData = {
            ...
            title: values.title,
            elder_id: values.elder.id,
            audios_time: timeToSeconds(values.audios_time), // Convert to seconds
          ...
          if (values.audio.file) {
            formData.audio = values.audio.file;
            formData.audios_time = timeToSeconds(toggle.duration.trim()); // Convert to seconds
          }
